...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      expect(brownie.ingredients).to_not include('nuts')
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ['nuts', 'chocolate', 'flour', 'egg']
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(brownie.serve).to eq("Chef Jason the Great Baker has made 1 brownies!")
    end
  end
